...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c253 = function(expression) { return expression; },
      peg$c254 = "[",
      ...
      peg$c285 = function(literal, members, parts) {
          return {
            type: "Type",
      ...
      peg$c291 = function(type, specifiers, id, value) {
          return {
      ...
      peg$c292 = function(type, storage, id) {
          return {
      ...
      peg$c357 = function(left, operator, right) {
            return {
              type:     "AssignmentExpression",
              operator: operator,
              left:     left,
      ...
      peg$c382 = function(declarations) {
            return {
      ...
      peg$c387 = function() { return { type: "EmptyStatement", start: location().start.offset, end: location().end.offset }; },
      ...
      peg$c391 = function(start_version, end_version) {
          return {
      ...
      peg$c394 = function(symbols, from) {
          return {
            type: "ImportStatement",
            from: from.value,
            symbols: symbols,
      ...
      peg$c395 = function(library, type) {
          return {
            type: "UsingStatement",
